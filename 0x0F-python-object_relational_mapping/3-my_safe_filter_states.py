...
of hbtn_0e_0_usa where name matches the argument. This script is safe from MySQL injections.
...
def find_state_safe(username, password, dbname, state_name):
...
if __name__ == "__main__":
    ...
    find_state_safe(username, password, dbname, state_name)
